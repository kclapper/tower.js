...
describe('sin', () => {
    test('racket docs examples', () => {
        expect(sin(new InexactNumber(3.14159)))
            .toEqual(new InexactNumber(2.65358979335273e-6));
    ...
    test('special values', () => {
        expect(sin(0)).toBe(0);
        expect(sin(PI))
            .toEqual(new InexactNumber(1.2246467991473532e-16));
        expect(sin(1))
            .toEqual(new InexactNumber(0.8414709848078965));
    });
    test('bigint', () => {
...
describe('cos', () => {
    test('racket docs examples', () => {
        expect(cos(new InexactNumber(3.14159)))
            .toEqual(new InexactNumber(-0.9999999999964793));
    ...
    test('special values', () => {
        ...
        expect(cos(1))
            .toEqual(new InexactNumber(0.5403023058681398));
    });
    test('bigint', () => {
...
describe('tan', () => {
    test('racket docs examples', () => {
        expect(tan(new InexactNumber(0.7854)))
            .toEqual(new InexactNumber(1.0000036732118496));
    ...
    test('special values', () => {
        ...
        expect(tan(PI))
            .toEqual(new InexactNumber(-1.2246467991473532e-16));
        expect(tan(1))
            .toEqual(new InexactNumber(1.5574077246549023));
    });
    test('bigint', () => {
...
describe('asin', () => {
    test('racket docs examples', () => {
        expect(asin(new InexactNumber(0.25)))
            .toEqual(new InexactNumber(0.25268025514207865));
...
describe('acos', () => {
    test('racket docs examples', () => {
        expect(acos(new InexactNumber(0.25)))
            .toEqual(new InexactNumber(1.318116071652818));
...
describe('atan', () => {
    test('racket docs examples', () => {
        expect(atan(new InexactNumber(0.5)))
            .toEqual(new InexactNumber(0.4636476090008061));
        expect(atan(2, 1))
            .toEqual(new InexactNumber(1.1071487177940904));
        expect(atan(-2, -1))
            .toEqual(new InexactNumber(-2.0344439357957027));
    ...
    test('special values', () => {
        expect(atan(0))
            .toBe(0);
        expect(atan(PI))
            .toEqual(new InexactNumber(1.2626272556789115));
        expect(atan(1))
            .toEqual(new InexactNumber(0.7853981633974483));
        expect(atan(INF, NEG_INF))
            .toEqual(new InexactNumber(2.356194490192345));
...
describe('sinh', () => {
    test('racket docs examples from other functions', () => {
        expect(sinh(new InexactNumber(0.25)))
            .toEqual(new InexactNumber(0.25261231680816826));
    ...
    test('special values', () => {
        ...
        expect(sinh(PI))
            .toEqual(new InexactNumber(11.548739357257748));
        expect(sinh(1))
            .toEqual(new InexactNumber(1.1752011936438014));
    });
    test('bigint', () => {
...
describe('cosh', () => {
    test('racket docs examples from other functions', () => {
        expect(cosh(new InexactNumber(0.25)))
            .toEqual(new InexactNumber(1.0314130998795732));
    ...
    test('special values', () => {
        ...
        expect(cosh(PI))
            .toEqual(new InexactNumber(11.591953275521519));
        expect(cosh(1))
            .toEqual(new InexactNumber(1.5430806348152437));
    });
    test('bigint', () => {
...
describe('tanh', () => {
    test('racket docs examples from other functions', () => {
        expect(tanh(new InexactNumber(0.25)))
            .toEqual(new InexactNumber(0.24491866240370913));
    ...
    test('special values', () => {
        ...
        expect(tanh(PI))
            .toEqual(new InexactNumber(0.99627207622075));
        expect(tanh(1))
            .toEqual(new InexactNumber(0.7615941559557649));
    });
    test('bigint', () => {
